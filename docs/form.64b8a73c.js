...
},{}],"fcxb":[function(require,module,exports) {
var define;
var global = arguments[3];
...
new _vue.default({
  ...
  methods: {
    ...
    emailValidator: function emailValidator(email) {
      var emailValidationExp = /^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$/;
      return emailValidationExp.test(email);
    },
    phoneValidator: function phoneValidator(phone) {
      var phoneValidationExp = /\(?([0-9]{3})\)?([ .-]?)([0-9]{3})\2([0-9]{4})/;
